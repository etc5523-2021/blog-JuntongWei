...
<br /> - About the number of **Accumulated deaths** in Indonesia, there is a rapidly increase start from Jun 2021, which is relevant with the second virus outbreak, from that, we can say the increase number of deaths is highly relevant with the number of new cases. 
